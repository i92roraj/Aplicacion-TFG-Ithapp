...
import 'schema/mediciones_record.dart';
...
export 'schema/mediciones_record.dart';
...
/// Functions to query MedicionesRecords (as a Stream and as a Future).
Future<int> queryMedicionesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MedicionesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MedicionesRecord>> queryMedicionesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MedicionesRecord.collection,
      MedicionesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MedicionesRecord>> queryMedicionesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
